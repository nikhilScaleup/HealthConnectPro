                            ...
                            <?php
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr>
                                        ...
                                        <a href="?action=view&id='.$scheduleid.'" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-view"  style="padding: 20px;padding-bottom: 12px;margin-top: 10px;"></button></a>
                                       &nbsp;&nbsp;&nbsp;
                                       <a href="?action=drop&id='.$scheduleid.'&name='.$title.'" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-delete"  style="padding: 20px;padding-bottom: 12px;margin-top: 10px;"></button></a>
                                        </div>
                                        </td>
                                    </tr>';
                                         ...
                                         for ( $x=0; $x<$result->num_rows;$x++){
                                             ...
                                             echo '<tr style="text-align:center;font-size:12px">
                                                ...
                                                '.substr($pid,0,15).'
                                                 ...
                                                 <td style="font-weight:600;padding:12px;font-size:12px">'.
