...
if($_POST){
	...
	$zipcode=$_SESSION['personal']['zipcode'];
	$company=$_SESSION['personal']['company'];
    ...
    if ($newpassword==$cpassword){
        ...
        if($result->num_rows==1){
            ...
            //TODO
            $database->query("insert into patient(pemail,pname,ppassword, paddress, pnic,pdob,ptel,pcity,pstate,pzipcode,pinsurancecompany) 
			values('$email','$name','$newpassword','$address','$nic','$dob','$tele','$city','$state','$zipcode','$company');");
